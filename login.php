...
if (isset($_POST['dangnhap'])) 
{
    ...
    if (!$username || !$password) {
        echo "Vui lòng nhập tên đăng nhập và mật khẩu. <a href='javascript: history.go(-1)'>Trở lại</a>";
        exit;
    }
    ...
    if (mysqli_num_rows($kq) == 0) {
        echo "Tên đăng nhập sai. Vui lòng kiểm tra lại. <a href='javascript: history.go(-1)'>quay lại</a>";
        exit;
    }
    ...
    if ($password != $row['password']) {
        echo "Mật khẩu không đúng. Vui lòng nhập lại. <a href='javascript: history.go(-1)'>quay lại</a>";
        exit;
    }
			...
			<div class="wrap-login101">
				<form class="" action="login.php" method="POST">
					...
					<div class="text-center p-t-90">
						<p class="" style="color: white">Bạn chưa có tài khoản.tạp tài khoản ngay
